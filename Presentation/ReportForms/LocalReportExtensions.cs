...
namespace Presentation.ReportForms
{
    ...
    {
        public static void PrintToPrinter(this LocalReport report, int idSale)
        {
            PageSettings pageSettins = new PageSettings();
            pageSettins.PaperSize = report.GetDefaultPageSettings().PaperSize;
            pageSettins.Landscape = report.GetDefaultPageSettings().IsLandscape;
            pageSettins.Margins = report.GetDefaultPageSettings().Margins;
            Print(report, pageSettins, idSale);
        }

        public static void Print(this LocalReport report, PageSettings pageSettings, int idSale)
        {
            string deviceInfo =
                $@"<DeviceInfo>
